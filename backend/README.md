...
## Project Structure
    ...
    ├── second_template_tes_35761  # Django project configurations
...
1. Clone this repo and `cd second_template_tes_35761`
...
2. Clone this repo and `cd second_template_tes_35761`
